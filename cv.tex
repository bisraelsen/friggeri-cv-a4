...
% Version 1.0
%
% Removed A4, updated bibliography:
% Brett Israelsen (bisraelsen.github.io)
% https://github.com/bisraelsen/my_Frigerri_CV
%
% A4 version author:
...
% 'a4' print a4 instead of letter
\documentclass[nocolors]{friggeri-cv}

\addbibresource{bibliography.bib} % Specify the bibliography file to include publications

%%%%%
% bibliography section config
% place the entry types you want in this document, IN ORDER of how you want them to appear
%%%%%

% bib categories, in order of appearance
...
% defined headings for the categories above
\defbibheading{bibliography}{\section{publications}} % overall bibliography title
\defbibheading{book}{\subsubsection{books}}
\defbibheading{article}{\subsubsection{journal articles}}
\defbibheading{report}{\subsubsection{reports}}
\defbibheading{inproceedings}{\subsubsection{presentations}}

%%%%%
% end bibliography config
%%%%%

\begin{document}

\header{brett}{smith}{junior business analyst} % Your name and current job title/field
