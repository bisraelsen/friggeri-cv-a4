...
\nocite{*}
\printbibliography[filter=articles,title={peer reviewed articles}, heading=friggeriSubHeading] % Print all articles from the bibliography

\printbibliography[filter=books,title={books}, heading=friggeriSubHeading, resetnumbers] % Print all books from the bibliography
